...
<head>
	...
	<!-- PAGE TITLE -->
	<title>STATIX table - activite</title>
	<!-- DATATABLE - import -->
...
<div class="container-lg py-4">
	...
	<div class="container-fluid">
		<!-- TITLE -->
		<h2 class="page-header text-center">- ACTIVITE -</h2>
		<!-- VERSION -->
					...
					<tbody>
						...
						<?php
							...
							echo
								...
								<td><span class='table-name'>".$row['activityName']."</span></td>
								<td><span class='table-freq'>".$row['activityFreq']."</span></td>
								<td><i>".$row['date']."</i></td>
								<td>
...
<a href="../../chart/chart_activity/index.html" target="_blank"><button class="button" style="vertical-align:middle; -moz-box-shadow:inset 2px 2px 25px #000000;

        ...
        <div class="modal-content">
			...
			<form method="POST" action="edit.php"> <!-- CALL EDIT.PHP (method=POST) -->
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="etabName" value="<?php echo $row['etabName']; ?>"> <!-- recup -->
					</div>
				</div>
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="number" class="form-control" min="0" max="50" name="etabFreq" value="<?php echo $row['etabFreq']; ?>"> <!-- recup -->
					</div>
				</div>

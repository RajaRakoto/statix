...
<head>
	...
	<!-- PAGE TITLE -->
	<title>STATIX table - etablissement</title>
	<!-- DATATABLE - import -->
...
<body onload=showDate();>
	...
	<div class="container-fluid">
		<!-- TITLE -->
		<h2 class="page-header text-center">- ETABLISSEMENT -</h2>
		<!-- VERSION -->
						...
						<?php
							...
							while($row = $query->fetch_assoc()){
								...
								"<tr>
									...
									<td><span class='table-name'>".$row['etabName']."</span></td>
									<td><span class='table-freq'>".$row['etabFreq']."</span></td>
									<td><i>".$row['date']."</i></td>
									<td>
...
<a href="../../chart/chart_etab/index.html" target="_blank"><button class="button" style="vertical-align:middle; -moz-box-shadow:inset 2px 2px 25px #000000;

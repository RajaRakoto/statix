        ...
        <div class="modal-content">
			...
			<form method="POST" action="edit.php"> <!-- CALL EDIT.PHP (method=POST) -->
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="filiereName" value="<?php echo $row['filiereName']; ?>"> <!-- recup -->
					</div>
				</div>
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="number" class="form-control" min="0" max="50" name="filiereFreq" value="<?php echo $row['filiereFreq']; ?>"> <!-- recup -->
					</div>
				</div>
            ...
            <div class="modal-body">	
            	<p class="text-center">Vous etes sur de vouloir supprimer ?</p>
							...
							<?php 
								...
								echo $row['filiereName'];
								echo "</li><br>";
								echo "<li><strong>[TOTAL]</strong>: ";
								echo $row['filiereFreq'];
								echo "</li>";
							?>
							</ul>
							</h5>

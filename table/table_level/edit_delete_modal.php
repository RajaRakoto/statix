        ...
        <div class="modal-content">
			...
			<form method="POST" action="edit.php"> <!-- CALL EDIT.PHP (method=POST) -->
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="levelName" value="<?php echo $row['levelName']; ?>"> <!-- recup -->
					</div>
				</div>
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="number" class="form-control" min="0" max="50" name="levelFreq" value="<?php echo $row['levelFreq']; ?>"> <!-- recup -->
					</div>
				</div>
